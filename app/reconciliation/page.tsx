...
/**
 * /reconciliation — Nightly reconciliation run history.
 *
 * Shows the 30 most recent reconciliation runs with status pills.
 * Click a row to expand the JSON details for forensic review.
 */
